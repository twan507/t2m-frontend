...
const UpdateLicenseModal = (props: IProps) => {
    ...
    useEffect(() => {
        if (updateLicenseRecord) {
            form.setFieldsValue({
                name: updateLicenseRecord.name,
                monthsDuration: updateLicenseRecord.monthsDuration,
                accessLevel: updateLicenseRecord.accessLevel,
                price: updateLicenseRecord.price
            })
        }
    }, [isUpdateModalOpen])
